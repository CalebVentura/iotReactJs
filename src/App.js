...
import './App.css'; //Estilos de este componente
      ...
      <div className="wrapper">
        ...
        <header className="main-header">
          <a href="index2.html" className="logo">
            <span className="logo-mini"><b>A</b>IOT</span>
            <span className="logo-lg"><b>Admin</b>IOT</span>
          </a>
              ...
              <section className="col-lg-7 connectedSortable">
                ...
                <div className="box box-success">
                  ...
                  <div className="box-body chat" id="chat-box">
                    ...
                    <div className="item">
                      <img src="dist/img/user4-128x128.jpg" alt="user image" className="online"></img>
                    ...
                    <div className="item">
                      <img src="dist/img/user3-128x128.jpg" alt="user image" className="offline"></img>
                    ...
                    <div className="item">
                      <img src="dist/img/user2-160x160.jpg" alt="user image" className="offline"></img>
                  ...
                  <div className="box-footer">
                    <div className="input-group">
                      <input className="form-control" placeholder="Type message..."></input>
                  ...
                  <div className="box-body">
                    <form action="#" method="post">
                      <div className="form-group">
                        <input type="email" className="form-control" name="emailto" placeholder="Email to:"></input>
                      </div>
                      <div className="form-group">
              ...
              <form method="post">
                ...
                <div className="form-group">
                  <label className="control-sidebar-subheading">
                    Report panel usage
                    <input type="checkbox" className="pull-right" checked></input>
                  </label>
                ...
                <div className="form-group">
                  <label className="control-sidebar-subheading">
                    ...
                    <input type="checkbox" className="pull-right"></input>
                  </label>
                </div>
